...
//執行資料庫動作的函式-取出單一商品
//------------------------------------------
var query = async function(nutrition_no){
    var result={};
...
var update = async function(newData){
    ...
    await sql('UPDATE project.nutrition SET nutrition_name=$1, nutrition_description=$2 WHERE nutrition_no = $3', [newData.nutrition_name, newData.nutrition_description, newData.nutrition_no])
        .then((data) => {
